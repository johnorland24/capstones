    ...
    <>  
      ...
      <Dialog open={profileOpen} onOpenChange={setProfileOpen}>  
        <DialogContent className="p-6">  
          ...
          <div className="mb-4">  
          <div className="mb-3">  
              <div className="block mb-1 font-sans">Name</div>
              <h1 className="w-full border-b border-blue-500 pb-2">{user.name}</h1>
            </div> 
            </div>  
            <div className="mb-3">  
              <div className="block mb-1 font-sans">Email</div>
              <h1 className="w-full border-b border-blue-500 pb-2">{user.email}</h1>
            </div> 
            <div className="mb-4">  
      ...
      <DropdownMenu>  
        ...
        <DropdownMenuContent className="w-48">  
          ...
          <h1 className="font-serif m-3">{user.name}</h1>
          <h1 className="font-light m-3">{user.email}</h1>
          <DropdownMenuSeparator />  
          <DropdownMenuItem onClick={() => setProfileOpen(true)} className="text-green-400  hover:text-green-600 transition-colors duration-200">  
            Edit Profile  
          </DropdownMenuItem>  
          <DropdownMenuItem onClick={() => setLogOutOpen(true)} className="text-red-400 hover:text-red-600 transition-colors duration-200">  
            Logout  
          </DropdownMenuItem>  
          <DropdownMenuItem >  
